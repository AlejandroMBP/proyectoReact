...
export default function UsuarioIndex({ users }: { users: User[] }) {
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse rounded-xl overflow-hidden">
                            ...
                            <tbody className="bg-white dark:bg-black divide-y divide-gray-300 dark:divide-gray-700">
                                {users.map((user) => (
                                    <tr key={user.id} className="hover:bg-gray-200 dark:hover:bg-gray-900 transition">
                                        ...
                                        <td className="p-3 text-center flex gap-2 justify-center">
                                            <button
                                                ...
                                                className="px-4 py-2 bg-blue-950 text-white font-semibold rounded-lg hover:bg-blue-600 transition"
                                            >
                                                Editar
                                            </button>
                                            <button
                                                onClick={() => handleDelete(user.id)}
                                                className="px-4 py-2 bg-gray-900 text-white font-semibold rounded-lg hover:bg-red-600 transition"
                                            >
                                                Eliminar
                                            </button>
                                        </td>
                ...
                <form onSubmit={handleEditSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2">
                        <button
                            ...
                            hover:bg-red-500 hover:border-red-500 hover:text-white transition-all duration-300 ease-in-out
                            dark:bg-sidebar dark:text-white dark:border-neutral-700 dark:hover:border-red-500 dark:hover:bg-black/4
                            ">
                            Cancelar
                        </button>
                        <button
                            type="submit"
                            className="px-5 py-2.5 rounded-xl border-2 border-black bg-white text-black
                            hover:bg-black hover:border-black hover:text-white transition-all duration-300 ease-in-out
                            dark:bg-sidebar dark:text-white dark:border-neutral-700 dark:hover:border-blue-900 dark:hover:bg-black/40"
                        >
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} title="Registrar Nuevo Usuario">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button
                            type="submit"
                            className="px-5 py-2.5 rounded-xl border-2 border-transparent bg-white text-black
               hover:bg-black hover:border-black hover:text-white transition-all duration-300 ease-in-out
               dark:bg-sidebar dark:text-white dark:border-neutral-700 dark:hover:border-blue-900 dark:hover:bg-black/40"
                        >
                            Agregar Usuario
